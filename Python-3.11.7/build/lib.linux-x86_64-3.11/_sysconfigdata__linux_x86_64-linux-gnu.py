...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/eai/py311/bin',
 'BINLIBDEST': '/eai/py311/lib/python3.11',
 'BLDLIBRARY': 'libpython3.11.a',
 'BLDSHARED': 'gcc -pthread -shared -L/eai/ssl/lib64 -L/eai/sqlite/lib '
              '-Wl,-rpath=/eai/ssl/lib64 -Wl,-rpath=/eai/sqlite/lib',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CC': 'gcc -pthread',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -I/eai/ssl/include/',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-I/eai/ssl/include/',
 'CONFIGURE_CFLAGS_NODIST': '-fno-semantic-interposition -std=c11 -Wextra '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/eai/sqlite/include',
 'CONFIGURE_LDFLAGS': '-L/eai/ssl/lib64 -L/eai/sqlite/lib '
                      '-Wl,-rpath=/eai/ssl/lib64 -Wl,-rpath=/eai/sqlite/lib',
 'CONFIGURE_LDFLAGS_NODIST': '-fno-semantic-interposition',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--prefix=/eai/py311' '--with-openssl=/eai/ssl' "
                "'--with-openssl-rpath=auto' '--enable-optimizations' "
                "'CFLAGS=-I/eai/ssl/include/' 'LDFLAGS=-L/eai/ssl/lib64 "
                '-L/eai/sqlite/lib -Wl,-rpath=/eai/ssl/lib64 '
                "-Wl,-rpath=/eai/sqlite/lib' 'CPPFLAGS=-I/eai/sqlite/include'",
 'CONFINCLUDEDIR': '/eai/py311/include',
 'CONFINCLUDEPY': '/eai/py311/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/root/Python-3.11.7/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/root/Python-3.11.7/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage '
                            '--title "CPython 3.11 LCOV report [commit $(shell '
                            ')]"',
 'CPPFLAGS': '-I. -I./Include -I/eai/sqlite/include',
 'CXX': 'g++ -pthread',
 ...
 'DESTDIRS': '/eai/py311 /eai/py311/lib /eai/py311/lib/python3.11 '
             '/eai/py311/lib/python3.11/lib-dynload',
 'DESTLIB': '/eai/py311/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/eai/py311/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/eai/py311/include /eai/py311/include '
                   '/eai/py311/include/python3.11 '
                   '/eai/py311/include/python3.11',
 'INCLUDEDIR': '/eai/py311/include',
 'INCLUDEPY': '/eai/py311/include/python3.11',
 ...
 'LDFLAGS': '-L/eai/ssl/lib64 -L/eai/sqlite/lib -Wl,-rpath=/eai/ssl/lib64 '
            '-Wl,-rpath=/eai/sqlite/lib',
 'LDLIBRARY': 'libpython3.11.a',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -L/eai/ssl/lib64 -L/eai/sqlite/lib '
             '-Wl,-rpath=/eai/ssl/lib64 -Wl,-rpath=/eai/sqlite/lib',
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/eai/py311/lib/python3.11',
 'LIBDIR': '/eai/py311/lib',
 'LIBEXPAT_A': 'Modules/expat/libexpat.a',
 'LIBEXPAT_CFLAGS': '-I./Modules/expat -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                    '-Wall -I/eai/ssl/include/ -fno-semantic-interposition '
                    '-std=c11 -Wextra -Wno-unused-parameter '
                    '-Wno-missing-field-initializers -Wstrict-prototypes '
                    '-Werror=implicit-function-declaration -fvisibility=hidden '
                    '-fprofile-use -fprofile-correction -I./Include/internal '
                    '-I. -I./Include -I/eai/sqlite/include -fPIC',
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/eai/py311/lib/pkgconfig',
 'LIBPL': '/eai/py311/lib/python3.11/config-3.11-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/eai/py311/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/eai/py311/share/man',
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/eai/ssl/include',
 'MODULE__HASHLIB_DEPS': './Modules/hashlib.h',
 'MODULE__HASHLIB_LDFLAGS': '-L/eai/ssl/lib  '
                            '-Wl,--enable-new-dtags,-rpath=/eai/ssl/lib  '
                            '-lcrypto',
 ...
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/eai/ssl/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/eai/ssl/lib  '
                        '-Wl,--enable-new-dtags,-rpath=/eai/ssl/lib -lssl '
                        '-lcrypto',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/eai/ssl/include',
 'OPENSSL_LDFLAGS': '-L/eai/ssl/lib',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
                             '-I/eai/ssl/include/ -fno-semantic-interposition '
                             '-std=c11 -Wextra -Wno-unused-parameter '
                             '-Wno-missing-field-initializers '
                             '-Wstrict-prototypes '
                             '-Werror=implicit-function-declaration '
                             ...
                             '-I./Include -I/eai/sqlite/include '
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
                   '-I/eai/ssl/include/ -fno-semantic-interposition -std=c11 '
                   '-Wextra -Wno-unused-parameter '
                   '-Wno-missing-field-initializers -Wstrict-prototypes '
                   '-Werror=implicit-function-declaration -fvisibility=hidden '
                   '-fprofile-use -fprofile-correction -I./Include/internal '
                   '-I. -I./Include -I/eai/sqlite/include -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/eai/ssl/lib64 -L/eai/sqlite/lib '
                    '-Wl,-rpath=/eai/ssl/lib64 -Wl,-rpath=/eai/sqlite/lib '
                    '-fno-semantic-interposition',
 'PY_CPPFLAGS': '-I. -I./Include -I/eai/sqlite/include',
 'PY_ENABLE_SHARED': 0,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/eai/ssl/lib64 -L/eai/sqlite/lib -Wl,-rpath=/eai/ssl/lib64 '
               '-Wl,-rpath=/eai/sqlite/lib',
 'PY_LDFLAGS_NODIST': '-fno-semantic-interposition',
 'PY_LDFLAGS_NOLTO': '-L/eai/ssl/lib64 -L/eai/sqlite/lib '
                     '-Wl,-rpath=/eai/ssl/lib64 -Wl,-rpath=/eai/sqlite/lib',
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './eai/py311',
 'WASM_STDLIB': './eai/py311/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 0,
 ...
 'abs_builddir': '/root/Python-3.11.7',
 'abs_srcdir': '/root/Python-3.11.7',
 'datarootdir': '/eai/py311/share',
 'exec_prefix': '/eai/py311',
 'prefix': '/eai/py311',
 'srcdir': '.'}
